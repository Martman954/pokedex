  ...
  return (
    <div className="pt-22 flex flex-col justify-center align-center max-w-full">
      ...
      <form
        ...
        className="flex justify-center my-4 gap-10"
      >
        <input
          type="text"
          value={searchInput}
      ...
      <div className="flex flex-row min-w-50 gap-10 justify-center my-4 ">
        <button
          className="cursor-pointer rounded-lg text-white bg-gray-900 shadow-lg shadow-indigo-700 trnsition-all
      ...
      <div className="flex flex-wrap text-center justify-center mx-20  max-w-full min-h-100">
        {pokeList.map((pokemon) => (
          <Link
            key={pokemon.id}
            to={`/Pokemon/${pokemon.id}?page=${currentPage}`}
          >
